...
#        self.label_2.setObjectName(_fromUtf8("label_2"))
    ...
    def pushButton_clicked(self):
    	os.system('./src/NeuronRobotics/Slic3r/slic3r.pl --load src/NeuronRobotics/Slic3r/default.ini src/NeuronRobotics/SERIAL_GUI/exported/temp.stl')
	command = 'python src/NeuronRobotics/SERIAL_GUI/Printrun/printcore.py '
	command += str(self.label.text())
	command += ' src/NeuronRobotics/SERIAL_GUI/exported/Board.gcode'
	os.system(command)
