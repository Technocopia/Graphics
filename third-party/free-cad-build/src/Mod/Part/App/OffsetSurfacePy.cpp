...
PyObject * OffsetSurfacePy::staticCallback_getOffsetValue (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(PyExc_Exception, "Unknown exception while reading attribute 'OffsetValue' of object 'GeomOffsetSurface'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ((OffsetSurfacePy*)self)->setOffsetValue(Py::Float(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(PyExc_Exception, "Unknown exception while writing attribute 'OffsetValue' of object 'GeomOffsetSurface'");
        return -1;
    }
}
...
PyObject * OffsetSurfacePy::staticCallback_getBasisSurface (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(PyExc_Exception, "Unknown exception while reading attribute 'BasisSurface' of object 'GeomOffsetSurface'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ...
        PyErr_SetString(PyExc_Exception, "Unknown exception while writing attribute 'BasisSurface' of object 'GeomOffsetSurface'");
        return -1;
    }
}
