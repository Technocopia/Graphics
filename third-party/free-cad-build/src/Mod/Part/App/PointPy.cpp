...
PyObject * PointPy::staticCallback_getX (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(PyExc_Exception, "Unknown exception while reading attribute 'X' of object 'GeomPoint'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ((PointPy*)self)->setX(Py::Float(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(PyExc_Exception, "Unknown exception while writing attribute 'X' of object 'GeomPoint'");
        return -1;
    }
}
...
PyObject * PointPy::staticCallback_getY (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(PyExc_Exception, "Unknown exception while reading attribute 'Y' of object 'GeomPoint'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ((PointPy*)self)->setY(Py::Float(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(PyExc_Exception, "Unknown exception while writing attribute 'Y' of object 'GeomPoint'");
        return -1;
    }
}
...
PyObject * PointPy::staticCallback_getZ (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(PyExc_Exception, "Unknown exception while reading attribute 'Z' of object 'GeomPoint'");
        return NULL;
    }
}
...
{    
    ...
    try {
        ((PointPy*)self)->setZ(Py::Float(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(PyExc_Exception, "Unknown exception while writing attribute 'Z' of object 'GeomPoint'");
        return -1;
    }
}
