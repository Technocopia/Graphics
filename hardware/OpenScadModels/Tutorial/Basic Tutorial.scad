...
//				note: everything but the functions (i.e. union, subtraction) gets ended in a semicolin, if you have an error somewhere and don't know what's wrong, you probably forgot to put a semicolon at the end of an object.
