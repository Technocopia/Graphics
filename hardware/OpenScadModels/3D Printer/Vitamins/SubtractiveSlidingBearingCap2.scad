...
module BearingCap()
{
	union()
	{
		difference()
		{
			union()
			{
				cube([BallBearingHeight()+PlasticWidth()+3dPrinterTolerance(), PlasticWidth()+3dPrinterTolerance(), SliderHeight()+PlasticWidth()+3dPrinterTolerance()]);
				...
				translate([0,PlasticWidth(),PlasticWidth()])
				{
